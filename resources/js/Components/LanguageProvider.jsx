...
const MESSAGES = {
    id: {
        ...
        'admin.cms_dojo_registrations': 'Pendaftaran Club',
        'admin.master_account': 'Master Akun',
        'admin.master_dojo': 'Master Club',
        ...
        'pwa.dojo_management': 'Manajemen Club',
    ...
    en: {
        ...
        'admin.cms_pricelist': 'CMS Pricelist',
        'admin.cms_dojo_registrations': 'Club Registrations',
        'admin.master_account': 'Account Master',
        'admin.master_dojo': 'Club Master',
        ...
        'pwa.dojo_management': 'Club Management',
...
const PHRASE_TRANSLATIONS = {
    ...
    'Rapor Kemampuan Atlet': 'Athlete Skill Report',
