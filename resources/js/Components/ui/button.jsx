...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-normal break-words text-center leading-tight rounded-xl text-sm font-medium text-neutral-900 ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-athlix-red focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97]",
  {
    variants: {
      variant: {
